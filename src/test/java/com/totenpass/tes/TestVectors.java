...
public class TestVectors {
    ...
    private char[] passhphrase = "My Secret Passphrase!".toCharArray();

    private Plaintext decrypt(String content) throws InvalidCipherTextException {
